...
mission_segment_values = [\
 '{:.6f}'.format(aircraft.depart_taxi_kg_per_s),
 '{:.6f}'.format(aircraft.hover_climb_kg_per_s),
 '{:.6f}'.format(aircraft.trans_climb_kg_per_s),
 '{:.6f}'.format(aircraft.depart_proc_kg_per_s),
 '{:.6f}'.format(aircraft.accel_climb_kg_per_s),
 '{:.6f}'.format(aircraft.cruise_initial_kg_per_s),
 '{:.6f}'.format(aircraft.decel_descend_drop_point_kg_per_s),
 '{:.6f}'.format(aircraft.drop_payload_kg_per_s),
 '{:.6f}'.format(aircraft.accel_climb_drop_point_kg_per_s),
 '{:.6f}'.format(aircraft.cruise_return_kg_per_s),
 '{:.6f}'.format(aircraft.decel_descend_kg_per_s),
 '{:.6f}'.format(aircraft.arrive_proc_kg_per_s),
 '{:.6f}'.format(aircraft.trans_descend_kg_per_s),
 '{:.6f}'.format(aircraft.hover_descend_kg_per_s),
 '{:.6f}'.format(aircraft.arrive_taxi_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_hover_climb_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_trans_climb_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_accel_climb_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_cruise_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_decel_descend_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_trans_descend_kg_per_s),
 '{:.6f}'.format(aircraft.reserve_hover_descend_kg_per_s),
]
