...
power_values_kw = [
    aircraft.depart_taxi_avg_shaft_power_kw,
    aircraft.hover_climb_avg_shaft_power_kw,
    aircraft.trans_climb_avg_shaft_power_kw,
    aircraft.accel_climb_avg_shaft_power_kw,
    aircraft.reserve_cruise_avg_shaft_power_kw,
    aircraft.decel_descend_avg_shaft_power_kw,
    aircraft.trans_descend_avg_shaft_power_kw,
    aircraft.hover_descend_avg_shaft_power_kw,
    aircraft.arrive_taxi_avg_shaft_power_kw,
    aircraft.reserve_hover_climb_avg_shaft_power_kw,
    aircraft.reserve_trans_climb_avg_shaft_power_kw,
    aircraft.reserve_accel_climb_avg_shaft_power_kw,
    aircraft.reserve_cruise_avg_shaft_power_kw,
    aircraft.reserve_decel_descend_avg_shaft_power_kw,
    aircraft.reserve_trans_descend_avg_shaft_power_kw,
    aircraft.reserve_hover_descend_avg_shaft_power_kw,
]
...
with open(log + 'power-profile-all.csv', 'w', newline='') as csvfile:
    ...
    csvwriter.writerow(['time', 'avg_power_kw'])
